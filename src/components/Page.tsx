...
export const Page = ({ header, main, aside, footer }: PageProps) => {
  return (
    <div className="@container dark:bg-black w-full">
      <div className="relative bg-zinc-50 lg:border-l lg:border-r border-zinc-300 max-w-screen-xl mx-auto px-6 @3xl:px-24 ring-1 ring-zinc-100 dark:bg-zinc-900 dark:ring-zinc-300/20">
        <PageHeader {...header} />
