  ...
  return (
    <div className="bg-neutral-50">
      <div className="relative bg-white max-w-screen-xl mx-auto px-6 md:px-24">
        <PageHeader {...header} />
        <div className="flex flex-col md:flex-row gap-6 md:gap-16 py-12 md:py-16">
          <main className="flex flex-col items-start gap-12 md:gap-16 md:w-2/3">{children}</main>
