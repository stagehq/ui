    ...
    {isHovering && isEditable && 
      ...
      >
        <div className="flex gap-1 items-center px-2 bg-zinc-800 rounded-lg">
          <div onClick={() => handleResize(3)} className={clsx("flex items-center justify-center w-10 h-8 hover:bg-zinc-700 rounded-md cursor-pointer", size === 3 ? "bg-zinc-600" : "bg-transparent")}>
            <div className="border-2 border-white w-5 h-2 rounded-sm">
            </div>
          </div>
          <div onClick={() => handleResize(2)} className={clsx("flex items-center justify-center w-10 h-8 hover:bg-zinc-700 rounded-md cursor-pointer", size === 2 ? "bg-zinc-600" : "bg-transparent")}>
            <div className="border-2 border-white w-4 h-4 rounded-sm">
            </div>
          </div>
          <div onClick={() => handleResize(1)} className={clsx("flex items-center justify-center w-10 h-8 hover:bg-zinc-700 rounded-md cursor-pointer", size === 1 ? "bg-zinc-600" : "bg-transparent")}>
            <div className="border-2 border-white w-2 h-5 rounded-sm">
            </div>
          </div>
        </div>
